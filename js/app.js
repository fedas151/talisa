(() => {
    ...
    function headerScroll() {
        ...
        const pseudo = document.querySelector("div.pseudo");
        const headerShow = header.hasAttribute("data-scroll-show");
        pseudo.hasAttribute("data-scroll-show");
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            if (scrollTop >= startPoint) {
                ...
                !pseudo.classList.contains("_main-scroll") ? pseudo.classList.add("_main-scroll") : null;
                if (headerShow) {
                    if (scrollTop < scrollDirection) header.classList.contains("_header-show") ? header.classList.remove("_header-show") : null; else !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null;
                    timer = setTimeout((() => {}), headerShowTimer);
                }
            } else {
                header.classList.contains("_header-scroll") ? header.classList.remove("_header-scroll") : null;
                pseudo.classList.contains("_main-scroll") ? pseudo.classList.remove("_main-scroll") : null;
